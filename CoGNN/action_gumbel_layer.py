...
class TempSoftPlus(Module):
    ...
    def __init__(self, gumbel_args: GumbelArgs, env_dim: int):
        ...
        model_list = gumbel_args.temp_model_type.get_component_list(in_dim=env_dim, hidden_dim=env_dim, out_dim=1, num_layers=1, bias=False, edges_required=False, gin_mlp_func=gumbel_args.gin_mlp_func)
